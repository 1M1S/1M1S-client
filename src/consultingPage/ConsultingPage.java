...
public class ConsultingPage extends JFrame {
    ...
    public ConsultingPage() {
        ...
        //패널 1 되돌아가기 버튼
        JButton panel1RollBackButton = new JButton(Images.RollBackButton.getImageIcon());
        ...
        //현재 페이지 index 버튼
        JButton panel1Index1Button = new JButton(Images.BookMarkImage1.getImageIcon());
        ...
        //다음 페이지 index 버튼
        JButton panel1Index2Button = new JButton(Images.BookMarkImage2.getImageIcon());
        ...
        //패널 1 되돌아가기 버튼
        JButton panel2RollBackButton = new JButton(Images.RollBackButton.getImageIcon());
        ...
        nextButton2.addActionListener(e -> {
            ...
            if(flag){
                ...
                if(good){
                    ...
                    //dispose 버튼
                    JButton panel3RollBackButton = new JButton(Images.ForumRollbackButton.getImageIcon());
        ...
        //이전 페이지 index 버튼
        JButton panel2Index1Button = new JButton(Images.BookMarkImage1.getImageIcon());
        ...
        //현재 페이지 index 버튼
        JButton panel2Index2Button = new JButton(Images.BookMarkImage2.getImageIcon());
    ...
    static class myPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            Dimension d = getSize();
            ImageIcon image = Images.ConsultingBackground.getImageIcon();
